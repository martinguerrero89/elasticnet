...
clonedir= "C:/Users/Martin/Desktop/Prot_Challenge/elasticnet-master"
datadir= "C:/Users/Martin/Desktop/Prot_Challenge/Data"
...
#PROTF= read.table("retrospective_ova_proteome_JHU_all_gene.txt",header=T,row.names=1,sep="\t")
#PROTF= read.table("retrospective_ova_proteome_PNNL_all_gene.txt",header=T,row.names=1,sep="\t")
